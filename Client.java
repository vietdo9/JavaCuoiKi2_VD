...
public class Client extends javax.swing.JFrame {
    ...
    public Client(String userName) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Có lỗi khi gửi tên người dùng đến máy chủ.");
        }
    }
    ...
    public static void main(String args[]) {
        String savedUsername = Preferences.userRoot().get("savedUsername", null); // Lấy tên người dùng đã lưu từ Preferences
        if (savedUsername != null) {
            new Client(savedUsername).setVisible(true); // Truyền tên người dùng vào Client
        } else {
